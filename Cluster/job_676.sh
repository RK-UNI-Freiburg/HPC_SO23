...
#SBATCH --output=job_676.out
#SBATCH --error=job_676.err
#SBATCH --export=ALL
...
#
UX_FILE="ux_500_676.npy"
UY_FILE="uy_500_676.npy"

cd ${SLURM_SUBMIT_DIR}
echo "We have a maximum of ${SLURM_NTASKS} tasks at our disposition"
mpirun --mca mpi_warn_on_fork 0 -n 676 python3 Sliding_Lid_Parallel_Cluster.py "$UX_FILE" "$UY_FILE"
