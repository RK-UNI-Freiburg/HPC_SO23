...
def run():
    ...
    save_mpiio(cartcomm, 'ux_300_4.npy', u_anm[0, 1:-1, 1:-1])
    save_mpiio(cartcomm, 'uy_300_4.npy', u_anm[1, 1:-1, 1:-1])


def main() -> None:
    ncpu = 9
    with ipp.Cluster(engines="mpi", n=ncpu) as rc:
        view = rc.broadcast_view()
        r = view.apply_sync(run())
