...
def main() -> None:
    ...
    ax.grid()
    ax.legend()
    plt.savefig(f'figures/Milestone3/ShearWaveDecay1.png', bbox_inches='tight')
    plt.show()
    ...
    plt.savefig(f'figures/Milestone3/Shear_Wave_Decay_Multiple_Omega2.png', bbox_inches='tight')
    plt.show()
    ...
    plt.savefig(f'figures/Milestone3/KinematicViscosity1.png', bbox_inches='tight')
    plt.show()'''
